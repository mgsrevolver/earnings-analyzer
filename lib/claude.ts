...

{
  ...
  "revenue": number (ALWAYS in millions - if reported in thousands, divide by 1000; if in dollars, divide by 1,000,000),
  "netIncome": number (ALWAYS in millions - if reported in thousands, divide by 1000; if in dollars, divide by 1,000,000),
  "operatingCashFlow": number (ALWAYS in millions, if available),
  "freeCashFlow": number (ALWAYS in millions, if available),
  "daysalesOutstanding": number (days, if mentioned),
  "deferredRevenue": number (ALWAYS in millions, if mentioned),
  ...
  "capexAmount": number (ALWAYS in millions, if mentioned),
